...
def test_employee_distribution_pie_chart_is_visible_after_scroll(
    ...
    admin_user,):
    open_dashboard(login_page, dashboard_page, admin_user)
    dashboard_page.scroll_to_widget(dashboard_page.employee_distribution_by_sub_unit_widget)
...
def test_employee_distribution_by_location_pie_chart_is_visible_after_scroll(
    ...
    admin_user,):
    open_dashboard(login_page, dashboard_page, admin_user)
    dashboard_page.scroll_to_widget(dashboard_page.employee_distribution_by_location_widget)
    dashboard_page.should_show_employee_distribution_by_location_pie_chart()
...
def test_employee_distribution_by_location_tooltip_is_shown_on_segment_hover(
    ...
    admin_user,):
    open_dashboard(login_page, dashboard_page, admin_user)
    dashboard_page.hover_over_employee_distribution_by_location_segment()
    dashboard_page.should_show_employee_distribution_by_location_tooltip()
...
def test_employee_distribution_by_location_legend_item_is_struck_through_after_click(
    ...
    admin_user,):
    open_dashboard(login_page, dashboard_page, admin_user)
    dashboard_page.click_first_employee_distribution_by_location_legend_item()
    dashboard_page.should_strike_through_first_employee_distribution_by_location_legend_item()
...
def test_employee_distribution_by_location_pie_chart_changes_after_legend_click(
    ...
    admin_user,):
    open_dashboard(login_page, dashboard_page, admin_user)
    initial_chart_snapshot = dashboard_page.get_employee_distribution_by_location_chart_snapshot()
    dashboard_page.click_first_employee_distribution_by_location_legend_item()
    updated_chart_snapshot = (
        dashboard_page.wait_until_employee_distribution_by_location_chart_changes(
            initial_chart_snapshot))
    assert initial_chart_snapshot != updated_chart_snapshot, (
